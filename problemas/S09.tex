...
3. Suponiendo que los capacitores están inicialmente descargados, halle $V_o$ (t) en el circuito. 
 \\ 
 ver figura\includegraphics{fig/Capacitor cargado graf.PNG}
 \begin{center}
     \begin{circuitikz}
         \draw
         (0,0)
...
7. Un inductor de 100 mH se conecta en paralelo con un resistor de 2$\kilo\omh$. La corriente por el inductor es i(t)=50e$^{-400}$ mA. 
