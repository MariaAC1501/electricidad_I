...
\begin{enumerate}
    \item Tomando en cuenta que los valores de $t_x$ van desde el 1 a 10 en incrementos de 1 y usando Python, Scilab, MATLAB cree un \emph{script} llamado ``respuetas'' que le permita realizar lo siguiente:
    \begin{itemize}
