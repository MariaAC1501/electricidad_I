...
\begin{itemize}
    ...
    \item Usando Xcos, realice una solución análoga a la realizada por el instructor pero para un circuito RC en serie con $R=\SI{0.2}{\ohm}$ y $C=\SI{20}{\milli\henry}$. Incluya su solución en el informe de su tarea, debe ser similar a lo incluido al inicio de este documento 
