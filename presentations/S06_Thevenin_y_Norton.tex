...
\title{
    Electricidad I:\\
    \alert{\emph{Teoremas de Thevenin, Norton y }}\\
    \alert{\emph{Máxima transferencia}}\\ 
    \alert{\emph{de potencia}}
}
\begin{document}
...
\begin{frame}{Teorema de máxima transferencia de potencia con $R_{Th}$ o $R_{N}$ negativa}
   En caso que la resistencia de Thevenin o Norton sea negativa, el circuito está generando potencia y por lo tanto el concepto de máxima transferencia de potencia pierde sentido. 
\end{frame}
