    ...
    \begin{tabularx}{\linewidth}{X X}
        ...
        \begin{circuitikz} [scale=1]\draw
            ...
            (0,3)
                to[R,v=$v_R$,-o]
            (2.5,3)
                to[open,v=$v$,xshift=0.3cm]
            (2.5,0)
            ;
        \draw (1,3.5)node[above, align=center]{Fuente \\de voltaje \\real};
        \draw (1,-1)node[above, align=center]{$v = v_F - v_R$};
        \end{circuitikz}
        &
        \centering
        \begin{circuitikz} [scale=1]\draw
            ...
            (1.5,0)
            ;
        \draw (1,3.5)node[above, align=center]{Fuente \\ de corriente \\real};
        \draw (1,-1)node[above, align=center]{$i = i_F - i_R$};
        \end{circuitikz}
    \end{tabularx}
\end{frame}
