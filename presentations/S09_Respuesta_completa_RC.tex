    ...
    \begin{column}{0.5\textwidth}
        ...
        {\begin{tikzpicture}
            \begin{axis}[
                ...
                table[x=t,y=vc,col sep=comma] {data/resp_comp_RC.csv};\addlegendentry{$v[\si{\volt}]$}
                \addplot [mark=none, color=red, thick]       
                table[x=t,y=ic,col sep=comma] {data/resp_comp_RC.csv};\addlegendentry{$i[\si{\ampere}]$}
                \addplot [mark=none, color=black, dashed]       
                table[x=t,y=vf,col sep=comma] {data/resp_comp_RC.csv};\addlegendentry{$v_f[\si{\volt}]$}
            \end{axis}
        \end{tikzpicture}
        }
    \end{column}
