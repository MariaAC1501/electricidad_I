    ...
    \begin{column}{0.5\textwidth}
        ...
        {\begin{tikzpicture}
            \begin{axis}[
                ...
                table[x=t,y=il,col sep=comma] {python/resp_comp_RL.csv};\addlegendentry{$i[\si{\ampere}]$}
                \addplot [mark=none, color=red, thick]       
                table[x=t,y=vl,col sep=comma] {python/resp_comp_RL.csv};\addlegendentry{$v[\si{\volt}]$}
                \addplot [mark=none, color=black, dashed]       
                table[x=t,y=if,col sep=comma] {python/resp_comp_RL.csv};\addlegendentry{$i_f[\si{\ampere}]$}
            \end{axis}
        \end{tikzpicture}
        }
    \end{column}
