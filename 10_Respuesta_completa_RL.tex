...
\begin{frame}{Ejemplo}
    ...
    \begin{column}{0.5\textwidth}
        ...
        \end{tikzpicture}
            ...
            {pero $i(\infty) = \SI{10}{\ampere}\,$, $\tau=\SI{1}{\second}\,$, $t_0 = \SI{1}{\second}\,$ y $v(1)=\SI{5}{\ampere}$, entonces: 
            \begin{equation*}
                v(t)=10\left(1-0.5e\,^{-(t - 1)}\right)         
            \end{equation*}
            }\onslide<8->
            {entonces: 
            \begin{equation*}
                v(4)=10\left(1-0.5e\,^{-3}\right)=\SI{9.751}{\ampere}      
            \end{equation*}
            }
        }\only<10-11>
            {\onslide<10->
            ...
            \begin{equation*}
                ...
                \begin{cases}
                    ...
                    5+4.751e^{-(t-4)} &\si{\ampere},\quad t \geq 3
                \end{cases}
            \end{equation*}
            }
            \onslide<13->
        ...
        {\begin{tikzpicture}
            \begin{axis}[
                ...
                table[x=t,y=vc,col sep=comma] {python/resp_comp_RC.csv};\addlegendentry{$i[\si{\ampere}]$}
                \addplot [mark=none, color=red, thick]       
                table[x=t,y=ic,col sep=comma] {python/resp_comp_RC.csv};\addlegendentry{$v[\si{\volt}]$}
                \addplot [mark=none, color=black, dashed]       
                table[x=t,y=vf,col sep=comma] {python/resp_comp_RC.csv};\addlegendentry{$i_f[\si{\ampere}]$}
            \end{axis}
        \end{tikzpicture}
        }
    \end{column}
