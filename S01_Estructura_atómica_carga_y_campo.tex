...
\begin{frame}{Campo eléctrico} 
    ...
    \begin{column}{0.55\textwidth}
        El campo eléctrico es la región alrededor de un cuerpo o partícula cargada dentro de la cual se ejercería una fuerza sobre otros cuerpos o partículas cargadas.  
        \begin{equation*}
            E = k\dfrac{q}{r^2}
        \end{equation*}
