...
\begin{frame}{Circuito RC: respuesta a un escalón}
    ...
    \begin{column}{0.5\textwidth}
        ...
        \end{equation*}
            ...
            {tenemos que:
            \begin{equation*}
                \ln(v-V)\,\bigg|_{v(t_0)}^{v(t)} = -\frac{t}{RC}\,\bigg|_{t_0}^{t}
            \end{equation*}
            }\onslide<9->
            {evaluando:
            \begin{equation*}
            ...
            {osea:
            \begin{equation*}
                \dfrac{\ln(v(t)-V)}{\ln (v(t_0)-V)} = -\frac{(t - t_0)}{RC}
            \end{equation*}
            }
        }\only<11-12>
            {\onslide<11->
            ...
            {\begin{equation*}
                ...
                \begin{cases}
                    0, & t < t_0\\
                    \dfrac{C}{\tau}(V-V_0)e\,^{(t - t_0)/ \tau}, & t > t_0
                \end{cases}
            \end{equation*}
            }
        }
...
\begin{frame}{Circuito RC: respuesta completa}
    \begin{equation*}
        u(t-t_0) =
        \begin{cases}
            0, & t < t_0\\
