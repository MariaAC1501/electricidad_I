...
\begin{frame}{Análisis de mallas por inspección}
    ...
    \only<6>{5. Sumar las fuentes de voltaje que son parte de la malla $a$, tomar como positivas las fuentes si la corriente de la malla $a$ \emph{sale} por el positivo}
    \only<7>{6. Sumar las resistencias que son parte de la malla $b$}
    \only<8>{7. Sumar las resistencia que la malla $b$ comparte con la malla $a$ y agregar un negativo}
    \only<9>{8. Sumar las fuentes de voltaje que son parte de la malla $b$, tomar como positivas las fuentes si la corriente de la malla $b$ \emph{sale} por el positivo}
